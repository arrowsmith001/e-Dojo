...
class SliverAppBar extends StatefulWidget {
  ...
  /// A widget to display before the [title].
  ///
  /// If this is null and [automaticallyImplyLeading] is set to true, the [MyAppbar] will
  /// imply an appropriate widget. For example, if the [MyAppbar] is in a [Scaffold]
  ...
  /// [Navigator] can go back, the [MyAppbar] will use a [BackButton] that calls
  /// [Navigator.maybePop].
  final Widget leading;
